...
import { OrderBusiness } from "../business/OrderBussiness"
...
constructor(
    ...
    public createOrder = async (req: Request, res: Response) => {
        try {
            ...
            const response = await this.orderBusiness.createOrderBusiness(input)
    ...
    public getOrders = async (req: Request, res: Response) => {
        try {
            const response = await this.orderBusiness.getOrderBusiness()
